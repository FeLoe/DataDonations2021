### This script is largely based on code gratefully copied from  https://github.com/MasterScrat/Chatistics
...
def main(own_name, file_path, max_exported_messages, infer_datetime):
    ...
    df = pd.DataFrame(data, columns = ['date','drop1','other','author','from_self','message','drop2','drop3'])
...
if __name__ == "__main__":
    ...
    parser.add_argument('file', help='The whatsapp chat txt file')
    parser.add_argument('own_name', help='Name of the person owning the device')
    args = parser.parse_args()

    o = main(args.own_name, args.file, MAX_EXPORTED_MESSAGES, True)
